...
export class CarsComponent implements OnInit {
  ...
  Cars = [
    ...
    },
    {
      ...
      model : 'Model:2010',
      // tslint:disable-next-line: max-line-length
      details : 'BMW cars price starts at Rs. 35.20 lakh for the cheapest car X1 and goes up to Rs. 2.43 crore for the top model BMW 7 Series. BMW offers 14 new car models in India. X1 (Rs. 35.20 lakh), Z4 (Rs. 64.90 lakh) and 3 Series GT (Rs. 47.70 lakh) are among the popular cars from BMW.',
    },
    {
    ...
    },
    {
      ...
      model : 'Model:2015',
      // tslint:disable-next-line: max-line-length
      details : 'The Mercedes-Benz E-Class has 2 Diesel Engine and 2 Petrol Engine on offer. ... Depending upon the variant and fuel type the E-Class has a mileage of 10.98 to 18.0 kmpl. The E-Class is a 5 seater Sedan and has a length of 4988mm, width of 1907mm and a wheelbase of 2939mm.',
    },
    {
